...
BoardingMenuSections = [
 'GROUP', "Let's go to...", "We're going to...", -1]
SellbotNerfMenuSections = [
 -1, 'GROUPING', 'SELLBOT TOWERS/VP']
LawbotNerfMenuSections = [
 -1, 'GROUPING', 'COURTHOUSE/CJ']
JellybeanJamMenuSections = [
 'GET JELLYBEANS', 'SPEND JELLYBEANS']
WinterMenuSections = [
 'CAROLING', -1]
