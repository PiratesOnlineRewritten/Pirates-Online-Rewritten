...
HOLIDAYS_WITH_CATALOGS = [
 SAINTPATRICKSDAY, VALENTINESDAY, WINTERFESTIVAL, MARDIGRAS, HALLOWEEN, NEWYEARS, MOTHERSDAY, FATHERSDAY]
...
holidaySchedules = {DOUBLEGOLDHOLIDAY: HolidayDates(HolidayDates.TYPE_CUSTOM, [
                     (
   ...
   JOLLYCURSEAUTO: HolidayDates(HolidayDates.TYPE_CUSTOM, [
                  (
                   2008, Month.DECEMBER, 12, 12, 0, 0), (2008, Month.DECEMBER, 15, 4, 0, 0), (2008, Month.DECEMBER, 19, 12, 0, 0), (2008, Month.DECEMBER, 22, 4, 0, 0)]),
   ...
   INVASIONPORTROYAL: HolidayDates(HolidayDates.TYPE_CUSTOM, []),WRECKEDGOVERNORSMANSION: HolidayDates(HolidayDates.TYPE_CUSTOM, []),INVASIONTORTUGA: HolidayDates(HolidayDates.TYPE_CUSTOM, [
                   (
                    2009, Month.DECEMBER, 11, 14, 0, 0), (2009, Month.DECEMBER, 11, 15, 45, 0), (2009, Month.DECEMBER, 11, 16, 0, 0), (2009, Month.DECEMBER, 11, 17, 45, 0), (2009, Month.DECEMBER, 11, 19, 0, 0), (2009, Month.DECEMBER, 11, 20, 45, 0), (2009, Month.DECEMBER, 12, 12, 0, 0), (2009, Month.DECEMBER, 12, 13, 45, 0), (2009, Month.DECEMBER, 12, 15, 0, 0), (2009, Month.DECEMBER, 12, 16, 45, 0), (2009, Month.DECEMBER, 12, 18, 0, 0), (2009, Month.DECEMBER, 12, 19, 45, 0), (2009, Month.DECEMBER, 13, 13, 0, 0), (2009, Month.DECEMBER, 13, 14, 45, 0), (2009, Month.DECEMBER, 13, 17, 0, 0), (2009, Month.DECEMBER, 13, 18, 45, 0), (2009, Month.DECEMBER, 13, 20, 0, 0), (2009, Month.DECEMBER, 13, 21, 45, 0)]),
   WRECKEDFAITHFULBRIDE: HolidayDates(HolidayDates.TYPE_CUSTOM, []),INVASIONDELFUEGO: HolidayDates(HolidayDates.TYPE_CUSTOM, [
                    (
                     2010, Month.JANUARY, 21, 12, 0, 0), (2010, Month.JANUARY, 21, 13, 45, 0), (2010, Month.JANUARY, 21, 15, 0, 0), (2010, Month.JANUARY, 21, 16, 45, 0), (2010, Month.JANUARY, 21, 18, 0, 0), (2010, Month.JANUARY, 21, 19, 45, 0)]),
   WRECKEDDELFUEGOTOWN: HolidayDates(HolidayDates.TYPE_CUSTOM, []),FLEETHOLIDAY: getHolidayConfigDatesDict(FleetHolidayConfigs),DOUBLECROSS: HolidayDates(HolidayDates.TYPE_CUSTOM, [
               (
   ...
   FEASTOFSTRENGTH: HolidayDates(HolidayDates.TYPE_CUSTOM, [
                   (
                    2010, Month.JANUARY, 23, 0, 0, 0), (2010, Month.JANUARY, 25, 0, 0, 0), (2010, Month.JANUARY, 30, 0, 0, 0), (2010, Month.FEBRUARY, 1, 0, 0, 0)]),
   ...
   KRAKENHOLIDAY: getHolidayConfigDatesDict(KrakenHolidayConfigs),CATALOGHOLIDAY: getHolidayConfigDatesDict(CatalogHolidayConfigs),MESSAGEHOLIDAY: getHolidayConfigDatesDict(MessageHolidayConfigs)}
holidaysEnglish = {}
holidaysJapanese = {}
holidaysGerman = {}
holidaysFrench = {}
...
RandomizedSchedules = {'Invasions': {'configs': [('want-random-invasions', 1), ('use-path-finding', 0)],'holidayIds': [INVASIONPORTROYAL, INVASIONTORTUGA, INVASIONDELFUEGO],'idOverrideDates': {INVASIONPORTROYAL: [((2010, 2, 4), (2010, 2, 28)), ((2010, 5, 1), (2010, 5, 31))],INVASIONTORTUGA: [((2010, 3, 1), (2010, 3, 31)), ((2010, 6, 1), (2010, 6, 30))],INVASIONDELFUEGO: [((2010, 4, 1), (2010, 4, 30)), ((2010, 7, 1), (2010, 7, 31))]},'conflictingIds': [CURSEDNIGHT],'conflictingClasses': [],'conflictingRSIds': [],'daysPerMonth': (5, 8),'numPerDay': 3,'timeWindows': [RandomTimeWindows.E, RandomTimeWindows.F, RandomTimeWindows.G],'duration': (1, 45)},'TreasureFleets': {'configs': [('want-random-treasurefleets', 1)],'holidayIds': [getHolidayId(FLEETHOLIDAY, FHConfigs.TF_EITC_RAND_KH_P_E_SW_S_W), getHolidayId(FLEETHOLIDAY, FHConfigs.TF_NAVY_RAND_KH_P_E_SW_S_W)],'idOverrideDates': {getHolidayId(FLEETHOLIDAY, FHConfigs.TF_EITC_RAND_KH_P_E_SW_S_W): [((2010, 1, 1), (2010, 4, 30))]},'conflictingIds': [CURSEDNIGHT],'conflictingClasses': [],'conflictingRSIds': [],'daysPerMonth': (5, 8),'numPerDay': 3,'timeWindows': [RandomTimeWindows.E, RandomTimeWindows.F, RandomTimeWindows.G, RandomTimeWindows.H],'duration': (1, 0)}}
MSG_START_ALL = 0
