...
from direct.distributed.ConnectionRepository import *
...
class PiratesAsyncRequest(AsyncRequest):
    """
    ...
    and return without calling PiratesAsyncRequest.finish().  Your finish method
    will be called again when the new self.neededObjects is complete.  You
    may repeat this as necessary.
    """
    _PiratesAsyncRequests = {}

    notify = DirectNotifyGlobal.directNotify.newCategory('PiratesAsyncRequest')
    ...
    def __init__(self, air, replyToChannelId = None,
        ...
        PiratesAsyncRequest._PiratesAsyncRequests[id(self)] = self
        self.deletingMessage = "PiratesAsyncRequest-deleting-%s"%(id(self,))
        self.air = air
    ...
    def delete(self):
        del PiratesAsyncRequest._PiratesAsyncRequests[id(self)]
        self.ignoreAll()
    ...
    def _resetTimeoutTask(self, createAnew = True):
        ...
        if createAnew:
            ...
            self.timeoutTask = taskMgr.doMethodLater(
                ...
                "PiratesAsyncRequestTimer-%s"%(id(self,)))
...
def cleanupPiratesAsyncRequests():
    """
    Only call this when the application is shuting down.
    """
    for PiratesAsyncRequest in PiratesAsyncRequest._PiratesAsyncRequests:
        PiratesAsyncRequest.delete()
    assert PiratesAsyncRequest._PiratesAsyncRequests == {}
