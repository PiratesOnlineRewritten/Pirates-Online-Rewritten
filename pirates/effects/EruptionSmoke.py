...
class EruptionSmoke(NodePath, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.1, Vec4(1, 0.25, 0, 0), Vec4(1, 0.4, 0.25, 1.0))
        self.p0.renderer.getColorInterpolationManager().addConstant(0.1, 0.4, Vec4(1, 0.4, 0.25, 1))
