...
class HealBlast(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(0.3, 1, 1, 0.5))
    ...
    def createTrack(self):
        ...
        self.p0.emitter.setAmplitude(8.5)
        self.p0.emitter.setOffsetForce(Vec3(0.0, 0.0, -6.5))
        self.startEffect = Sequence(Wait(0.35), Func(self.p0.setBirthRate, 0.03), Func(self.p0.clearToInitial), Func(self.f.start, self, self))
