...
class LavaSmoke(PooledEffect, EffectController):
    ...
    def __init__(self, parent=None):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.4, Vec4(0.6, 0.3, 0.3, 1.0), Vec4(0.1, 0.1, 0.1, 1.0))
        self.p0.renderer.getColorInterpolationManager().addConstant(0.4, 1.0, Vec4(0.1, 0.1, 0.1, 1))
    ...
    def createTrack(self, lod=Options.SpecialEffectsHigh):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.3), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
