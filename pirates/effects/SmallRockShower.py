...
class SmallRockShower(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.factory.setMassSpread(0.1)
    ...
    def createTrack(self):
        self.track = Sequence(Func(self.p0.setBirthRate, 0.025), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.3), Func(self.p0.setBirthRate, 100), Wait(3.0), Func(self.cleanUpEffect))
