...
class SmokePowderEffect(PooledEffect, EffectController):
    ...
    def createTrack(self):
        self.track = Sequence(Func(self.p0.setBirthRate, 0.02), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.3), Func(self.p0.setBirthRate, 200), Wait(self.duration), Func(self.cleanUpEffect))
