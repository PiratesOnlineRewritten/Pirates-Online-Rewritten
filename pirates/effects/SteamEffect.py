...
class SteamEffect(PooledEffect, EffectController):
    ...
    def createTrack(self, lod=Options.SpecialEffectsHigh):
        ...
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.6), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
