...
class VoodooShield(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0, 0, 1, 0.6), Vec4(0.8, 0.9, 1, 0.6), 1)
    ...
    def createTrack(self):
        self.startEffect = Sequence(Func(self.p0.clearToInitial), Func(self.p0.setBirthRate, 0.1), Func(self.f.start, self, self))
