...
class VoodooSmokeAura(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(0.8, 0.8, 0.8, 0.6))
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.2, Vec4(0, 0, 0, 0), Vec4(1.0, 0.4, 0.4, 1), 1)
        self.p0.renderer.getColorInterpolationManager().addLinear(0.2, 1.0, Vec4(1.0, 0.4, 0.4, 1.0), Vec4(0, 0, 0, 1), 1)
    ...
    def createTrack(self):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.025), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy))
