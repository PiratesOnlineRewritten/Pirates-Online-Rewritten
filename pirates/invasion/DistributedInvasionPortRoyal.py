...
class DistributedInvasionPortRoyal(DistributedInvasionObject.DistributedInvasionObject):
    ...
    def announceGenerate(self):
        ...
        if self.canPlaySfx:
            ...
            self.waveMessages = [
             loadSfx(SoundGlobals.SFX_MONSTER_JR_BREAK), loadSfx(SoundGlobals.SFX_MONSTER_JR_TONIGHT), loadSfx(SoundGlobals.SFX_MONSTER_JR_NOT_BAD), loadSfx(SoundGlobals.SFX_MONSTER_JR_ACCEPT), loadSfx(SoundGlobals.SFX_MONSTER_JR_IF_ONLY), loadSfx(SoundGlobals.SFX_MONSTER_JR_HOWS_THIS), loadSfx(SoundGlobals.SFX_MONSTER_JR_RIP), loadSfx(SoundGlobals.SFX_MONSTER_JR_FIGHT), loadSfx(SoundGlobals.SFX_MONSTER_JR_BRING), loadSfx(SoundGlobals.SFX_MONSTER_JR_ITCHING_TO_FIGHT), loadSfx(SoundGlobals.SFX_MONSTER_JR_FORWARD), loadSfx(SoundGlobals.SFX_MONSTER_JR_MANSION_DESTROYED), loadSfx(SoundGlobals.SFX_MONSTER_JR_PORT_ROYAL_MINE), loadSfx(SoundGlobals.SFX_MONSTER_JR_SPINELESS_FOOLS), loadSfx(SoundGlobals.SFX_MONSTER_JR_STORM_THE_BEACHES), loadSfx(SoundGlobals.SFX_MONSTER_JR_GET_YE), loadSfx(SoundGlobals.SFX_MONSTER_JR_FIGHT_ON), loadSfx(SoundGlobals.SFX_MONSTER_JR_FEAST_SOULS), loadSfx(SoundGlobals.SFX_MONSTER_JR_FASTER_YOU_SCABS), loadSfx(SoundGlobals.SFX_MONSTER_JR_DISPATCH), loadSfx(SoundGlobals.SFX_MONSTER_JR_DESTROY_EVERYTHING), loadSfx(SoundGlobals.SFX_MONSTER_JR_BEG_MERCY), loadSfx(SoundGlobals.SFX_MONSTER_JR_BARRICADES_A), loadSfx(SoundGlobals.SFX_MONSTER_JR_ATTACK_THE_TOWN), loadSfx(SoundGlobals.SFX_MONSTER_JR_ATTACK)]
    ...
    def updateBrigadeText(self):
        if self.brigadeText and self.parentObj.minimapArea:
            ...
            self.brigadeText = DirectLabel(parent=self.parentObj.minimap.getOverlayNode(), relief=None, text=PLocalizer.InvasionJollyRogerBrigadeUpdate % (self.currentPhase, self.totalPhases - self.currentPhase), text_align=TextNode.ALeft, text_fg=PiratesGuiGlobals.TextFG2, text_font=PiratesGlobals.getPirateOutlineFont(), text_shadow=PiratesGuiGlobals.TextShadow, textMayChange=1, scale=40, pos=(-800,
                                                                                                                                                                                                                                                                                                                                                                                                              -600,
                                                                                                                                                                                                                                                                                                                                                                                                              0), hpr=(0,
                                                                                                                                                                                                                                                                                                                                                                                                                       -90,
                                                                                                                                                                                                                                                                                                                                                                                                                       0))
