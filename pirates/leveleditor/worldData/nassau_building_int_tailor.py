...
objectStruct = {
    ...
    'Objects': {
        '1153417506.828659a2': {
            ...
            'Name': '',
            'AdditionalData': ['interior_spanish_store_tailor'],
            'Instanced': True,
            'Objects': {
                ...
                '1201040499.45dxschafe': {
                    ...
                    'Pos': Point3(-13.404, 47.298, 5.038),
                    'Scale': VBase3(1.0, 1.0, 1.0)
                }
            },
            'Visual': {
    ...
    'ObjectIds': {
        '1153417506.828659a2': '["Objects"]["1153417506.828659a2"]',
        '1196896512.0dxschafe': '["Objects"]["1153417506.828659a2"]["Objects"]["1196896512.0dxschafe"]',
        '1201040499.45dxschafe': '["Objects"]["1153417506.828659a2"]["Objects"]["1201040499.45dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(-31.4448, 103.882, 98.7015),
    'camHpr': VBase3(-168.328, -38.6405, 2.18614e-06),
