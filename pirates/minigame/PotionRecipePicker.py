...
class PotionRecipePicker(DirectFrame):
    ...
    def setupScene(self):
        ...
        self.title = DirectLabel(parent=self.background, relief=None, text=PLocalizer.PotionGui['RecipeList'], text_scale=PiratesGuiGlobals.TextScaleTitleSmall, text_align=TextNode.ACenter, text_fg=PotionGlobals.TextColor, text_wordwrap=30, pos=(0.57,
                                                                                                                                                                                                                                                      0,
                                                                                                                                                                                                                                                      0.77), textMayChange=0)
        self.recipeList = DirectScrolledList(parent=self, numItemsVisible=23, pos=(0.25, 0, -0.4), decButton_pos=(0.72,
                                                                                                                  0.0,
                                                                                                                  1.04), incButton_pos=(0.72, 0.0, -0.18), decButton_hpr=(0,
                                                                                                                                                                          0.0,
                                                                                                                                                                          0), incButton_hpr=(0,
                                                                                                                                                                                             0.0,
                                                                                                                                                                                             180), itemFrame_pos=(0,
                                                                                                                                                                                                                  0,
                                                                                                                                                                                                                  1.1), decButton_scale=0.07, decButton_image=(guiAssets.find('**/pir_t_gui_pot_scrollbutton'), guiAssets.find('**/pir_t_gui_pot_scrollbuttonOn'), guiAssets.find('**/pir_t_gui_pot_scrollbuttonOn'), guiAssets.find('**/pir_t_gui_pot_scrollbuttonDisable')), decButton_image_scale=(2.0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      2.0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      2.0), decButton_relief=None, incButton_scale=0.07, incButton_image=(guiAssets.find('**/pir_t_gui_pot_scrollbutton'), guiAssets.find('**/pir_t_gui_pot_scrollbuttonOn'), guiAssets.find('**/pir_t_gui_pot_scrollbuttonOn'), guiAssets.find('**/pir_t_gui_pot_scrollbuttonDisable')), incButton_image_scale=(2.0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 2.0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 2.0), incButton_relief=None, itemFrame_scale=1.0, forceHeight=0.0616)
        self.buttons = []
