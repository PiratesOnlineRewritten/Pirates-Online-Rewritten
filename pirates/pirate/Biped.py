...
jsCustomAnimList = (
 (
  'idle', 'js_idle'), ('emote_bow', 'js_emote_bow'), ('emote_hands_on_hips', 'js_emote_hands_on_hips'), ('emote_scared', 'js_emote_scared'), ('run', 'js_run'), ('run_diagonal_left', 'js_run_diagonal_left'), ('run_diagonal_right', 'js_run_diagonal_right'), ('run_with_weapon', 'js_run_with_weapon'), ('strafe_left', 'js_strafe_left'), ('strafe_right', 'js_strafe_right'), ('turn_left', 'js_turn_left'), ('turn_right', 'js_turn_right'), ('walk', 'js_walk'), ('walk_back_diagonal_left', 'js_walk_back_diagonal_left'), ('walk_back_diagonal_right', 'js_walk_back_diagonal_right'), ('sit_idle', 'js_playing_cards_idle'), ('into_sit_speak_idle', 'js_playing_cards_into_look'), ('sit_speak_idle', 'js_playing_cards_look_idle'), ('outof_sit_speak_idle', 'js_playing_cards_outof_look'), ('hands_on_hips', 'js_handsOnHips'), ('idle_to_bow', 'js_idleToBow'), ('special_bow', 'js_tv_bow'), ('walk_camera', 'js_walk_camera'), ('marketing_fight_jr', 'js_marketing_fight_jr'))
wtCustomAnimList = (
 (
  'idle', 'wt_spar_idle'), ('outof_speak_idle', 'wt_spar_outof_look'), ('into_speak_idle', 'wt_spar_into_look'), ('speak_idle', 'wt_spar_look_idle'))
esCustomAnimList = (
 (
  'sit_idle', 'es_sit_idle'), ('into_sit_speak_idle', 'es_sit_into_look'), ('sit_speak_idle', 'es_sit_look_idle'), ('outof_sit_speak_idle', 'es_sit_outof_look'))
tdCustomAnimList = (
 (
  'sit_idle', 'td_pet_idle'), ('into_sit_speak_idle', 'td_pet_into_look'), ('sit_speak_idle', 'td_pet_look_idle'), ('outof_sit_speak_idle', 'td_pet_outof_look'), ('show_voodoo_doll', 'td_show_voodoo_doll'))
cbCustomAnimList = (
 (
  'idle', 'cb_eat_apple_idle'), ('into_speak_idle', 'cb_eat_apple_into_look'), ('speak_idle', 'cb_eat_apple_look_idle'), ('outof_speak_idle', 'cb_eat_apple_outof_look'))
jgCustomAnimList = (
 (
  'sit_idle', 'jg_playing_cards_idle'), ('into_sit_speak_idle', 'jg_playing_cards_into_look'), ('sit_speak_idle', 'jg_playing_cards_look_idle'), ('outof_sit_speak_idle', 'jg_playing_cards_outof_look'))
jrCustomAnimList = (
 (
  'idle', 'jr_look_idle'), ('jr_look_idle', 'jr_look_idle'), ('jr_look_idle_2', 'jr_look_idle_2'), ('marketing_fight_js', 'jr_marketing_fight_js'), ('haunted_holiday', 'jr_haunted_holiday'))
plfCustomAnimList = (
 (
  'drunk_idle', 'plf_drunk_idle'), ('drunk_into_look', 'plf_drunk_into_look'), ('drunk_look_idle', 'plf_drunk_look_idle'), ('drunk_outof_look', 'plf_drunk_outof_look'))
plsCustomAnimList = (
 (
  'drunk_idle', 'pls_drunk_idle'), ('drunk_into_look', 'pls_drunk_into_look'), ('drunk_look_idle', 'pls_drunk_look_idle'), ('drunk_outof_look', 'pls_drunk_outof_look'))
